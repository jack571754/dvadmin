...
2. **dvadmin_approval** - 审批流程模块（已被 dvadmin3_flow 替代，保留参考）
...
```mermaid
graph TD
    A["DVAdmin 项目根<br/>d:/project/dvadmin"] --> B["django-vue3-admin-master<br/>(主项目)"];
...
| 文档文件 | 26 个 | CLAUDE.md 文档（7500+ 行） |
| **总计** | **340+** | 核心业务代码文件（不含 node_modules/__pycache__） |
...
### 2026-06-03 (删除博客管理模块)
- ✅ 彻底删除独立的 blog-frontend 博客前端应用
- ✅ 彻底删除 backend/dvadmin/blog 博客后端应用
- ✅ 彻底删除 web/src/views/blog/ 和 web/src/api/blog/ 前端管理页面及 API
- ✅ 清理 settings.py、urls.py 以及初始化脚本 init_all.py 中的博客模块注册 and 路由
- ✅ 清理 docker-compose 配置文件中关于 blog-frontend 的服务定义
- ✅ 更新相关文档（README.md, START.md, CLAUDE.md）
